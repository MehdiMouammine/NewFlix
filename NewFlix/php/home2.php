...
<div id="movie1" onmouseenter="red(1)" onmouseleave="normal(1)" style="background-color: #000000; font-size: 1.6em; color: white; padding-top: 1%; padding-left: 0.7%; padding-right: 0.7%; font-family: Impact;"><a href="home.php" style="text-decoration: none;"><div style="color: white;"> Series</div></a></div>
<div style="background-color: #CC0000; font-size: 1.6em; color: white; padding-top: 1%; padding-left: 0.7%; padding-right: 0.7%; font-family: Impact;"><a href="home2.php" style="text-decoration: none;"><div style="color: white;"> Movies</div></a></div>
...
<br>
          <div class="slideshow-container" width="100%" style="margin-top: 2.75%;" >
			...
			<br>
			<span style="font-family: Tahoma;font-size: 1em; margin-left: 3%; margin-top: 3%; color: green;">'.$serie->getYear().' &nbsp;&nbsp;'.$serie->getDuration().' Minutes</span><br>
