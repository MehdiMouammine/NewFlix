...
function carousel() {
  ...
  setTimeout(carousel, 5000);
	...
	xhttp1.open("GET", "Mostwatched.php", true);
	xhttp1.send();
	...
	xhttp2.open("GET", "Lastadded.php", true);
	xhttp2.send();
	...
	xhttpxx.open("GET", "Favoris.php", true);
	xhttpxx.send();
	...
	xhttp3.open("GET", "Random.php", true);
	xhttp3.send();
	function rech() {
	var n = $("#rechr").val();
	if (n != "") {
	...
	xhttp3.open("GET", "Search.php?Search="+n, true);
	xhttp3.send();
	}
	else {
		$("#tit1").slideUp();
	...
	xhttp.open("GET", "Seriebar.php?Ser="+n, true);
	xhttp.send();
	}
	function charger1(n) {
	$("#ser3").slideDown(1000);
	...
	function play(n) {
		$("#"+n+"bar2").slideDown(2000);
        $("#"+n+"bar").slideUp(2000);
        var xhttp = new XMLHttpRequest();
		xhttp.open("GET", "Count.php?Ser="+n, true);
		xhttp.send();
	}
	function slist(sr,us) {
		$(".er").slideUp(1000);
        var xhttp = new XMLHttpRequest();
		xhttp.open("GET", "List.php?Ser="+sr+"&Usr="+us, true);
		xhttp.send();
		var xhttpxx = new XMLHttpRequest();
		xhttpxx.onreadystatechange = function(){
		if (this.readyState == 4 && this.status == 200) {
	...
	function noslist(sr,us) {
		$(".er").slideUp(1000);
        var xhttp = new XMLHttpRequest();
		xhttp.open("GET", "NoList.php?Ser="+sr+"&Usr="+us, true);
		xhttp.send();
		var xhttpxx = new XMLHttpRequest();
		xhttpxx.onreadystatechange = function(){
		if (this.readyState == 4 && this.status == 200) {
